...
func TestUpdateValidatorBlocks(t *testing.T) {
	t.Skip("Skip updateValidatorBlocks as it will be removed in the next release")
}

func TestUpdateValidators(t *testing.T) {
	t.Skip("Skip updateValidators as it will be removed in the next release")
}
...
func TestSlash(t *testing.T) {
	...
	err = env.engine.slash(validator, env.statedb, header, cx, &txs, &receipts, &systemTxs, &usedGas, mining)
	if err != nil {
		...
		genspec = &core.Genesis{
			...
			Alloc: map[common.Address]core.GenesisAccount{
				...
				_stakeManagerAddress: {
					...
					*/
					Code:    common.FromHex(""),
					Balance: common.Big0,
				},
			},
		}
