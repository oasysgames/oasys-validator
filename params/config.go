...
var (
	...
	OasysMainnetGenesisHash = common.HexToHash("0x2759c556e190644c286d0ebbf425f3c087775003485ba8b179aa709b6eb5a84b")
	OasysTestnetGenesisHash = common.HexToHash("0x36dd0fc193654dd597d7625714750c5194373eed447526062cc746fd5264fb4c")
)
...
var (
	...
	// AllOasysProtocolChanges contains every protocol change (EIPs) introduced.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllOasysProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, &OasysConfig{Period: 0, Epoch: 30000}}
